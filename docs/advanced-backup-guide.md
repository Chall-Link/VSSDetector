...
#### ４．１． 設定条件、注意事項
ここでは、フォルダをソースにする場合は下記の設定で説明します：
- **設定例：**  
...
- **重要な確認事項：**
バックアップ作成後に7-Zip File Managerでファイルを開きファイルツリーを正しく閲覧できるかなど必ず確認してください
...
> **7-ZipのGUI方式**は、全ての7-Zipのオプションは使えず、またドライブ全体の長時間処理にも向いていません
